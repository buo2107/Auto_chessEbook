...
class ViewController: UIViewController {
  ...
  @IBAction func playGame(_ sender: Any) {
    ...
    boxNode.geometry?.firstMaterial?.diffuse.contents = UIColor(_colorLiteralRed: 0.01 * Float(height), green: 0.5, blue: 1, alpha: 1)
  ...
  func addNewBlock(_ currentBoxNode: SCNNode) {
    ...
    newBoxNode.geometry?.firstMaterial?.diffuse.contents = UIColor(_colorLiteralRed: 0.01 * Float(height), green: 0.5, blue: 1, alpha: 1)
  ...
  func addBrokenBlock(_ currentBoxNode: SCNNode) {
    ...
    if height % 2 == 0 && absoluteOffset.z > 0 {
      ...
      brokenBoxNode.geometry?.firstMaterial?.diffuse.contents = UIColor(_colorLiteralRed: 0.01 * Float(height), green: 1, blue: 1, alpha: 1)
